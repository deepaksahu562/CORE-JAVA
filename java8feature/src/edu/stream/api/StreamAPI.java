...
public class StreamAPI {
    public static void main(String[] args) {
        ...
        //System.out.println("Count of cities which name length greater than 5 words, is :" + count);
        ...
        //list.stream().min((data1, data2) -> data1.compareTo(data2)).ifPresent(System.out::println);
        ...
        /** SORTING ascending SortValues */
        /*Collections.sort(list);
        System.out.println(list);*/
        //list.stream().sorted().forEach(System.out::println);

        /** SORTING descending SortValues */
